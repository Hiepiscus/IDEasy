...
* https://github.com/devonfw/IDEasy/issues/2183[#2240]: Support file and folder selection
* https://github.com/devonfw/IDEasy/issues/2183[#2183]: Dynamically generate form fields for selected commandlet
